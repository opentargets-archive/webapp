angular.module('otFacets')
    .factory('rnaSpecificityFacetParser', ['otFilterTypes', function (otFilterTypes) {
        var parse = function (facetName, apiData, facetsGlobal, countsKey, options) {
            ...
            var rnaLevelKey = 'zscore_expression_level';
            var rnaTissueKey = 'zscore_expression_tissue';
            var rnaHierarchyKey = 'zscore_expression_hierarchy';
            var histogramData;
            ...
            var constructHistogram = function () {
                ...
                var cdfTopUp = [];
                for (var i = cdfRaw.length + 1; i <= 6; i++) {
                    cdfTopUp.push({
                        key: i,
                        value: 0
                    });
