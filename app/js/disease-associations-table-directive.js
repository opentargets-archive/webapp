 ...
 */
    .directive('cttvDiseaseAssociations', ['$log', 'cttvUtils', 'cttvDictionary', 'cttvFiltersService', 'cttvConsts', 'cttvAPIservice', '$q', 'cttvLocationState',
        function ($log, cttvUtils, cttvDictionary, cttvFiltersService, cttvConsts, cttvAPIservice, $q, cttvLocationState) {
            ...
            var setupTable = function (table, disease, target, filename, excludedTargetList, download, stt) {
                $log.log("setupTable():filename=", filename);
                $log.log("setupTable():excludedTargetList=", excludedTargetList);
                $log.log("setupTable():downloadAction =", download);
                stt = stt || {};
                ...
                var t = $(table).DataTable({
                        ...
                        "ajax": function (data, cbak, params) {
                            ...
                            console.log("directive:154:target", target);
                            var opts = {
                                disease: disease,
                                target: target,
                            ...
                            cttvAPIservice.getAssociationsPost(opts)
                                ...
                                .then(function (resp) {
                                console.log("directive:154:resp=", resp);
            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    ...
                    console.log("LINE341:attrs",attrs)
                    ...
                    scope.$watchGroup(["filters", "disease", "target", "excludedtargetlist"], function (attrs) {
                        ...
                        //    dtable.ajax.reload();
                        //} else {
                        console.log("diseaseAssociationsTableDirective:calling setupTable: scope.target=", scope.target);
                        console.log("diseaseAssociationsTableDirective:calling setupTable: scope.excludedTargetList=", scope.excludedTargetList);
                        //state = cttvLocationState.getState()[scope.stateId];
                        // create a new table
