...
angular.module('otControllers')
    ...
    .controller('SearchBoxController', ['$scope', '$location', '$window', '$document', '$element', 'otAPIservice', 'otConsts', '$q', 'otUtils', 'otLoadedLists', function ($scope, $location, $window, $document, $element, otAPIservice, otConsts, $q, otUtils, otLoadedLists) {
