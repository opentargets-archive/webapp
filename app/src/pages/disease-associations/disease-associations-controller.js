 ...
 */
    ...
    .controller('DiseaseAssociationsController', ['$scope', '$location', '$q', 'otAPIservice', 'otFiltersService', 'otDictionary', 'otUtils', 'otLocationState', 'otConfig', function ($scope, $location, $q, otAPIservice, otFiltersService, otDictionary, otUtils, otLocationState, otConfig) {
        'use strict';
