...
angular.module('otControllers')
     ...
     */
    .controller('SearchAppCtrl', ['$scope', '$location', '$log', 'otAppToApi', 'otApi', 'otUtils', 'otLocationState', function ($scope, $location, $log, otAppToApi, otApi, otUtils, otLocationState) {
        'use strict';
