...
angular.module('otServices')
     ...
     *
     */
    .factory('otFacetsFilters', ['$log', 'otDictionary', 'otConsts', 'otLocationState', '$analytics', '$injector', 'otConfig', function ($log, otDictionary, otConsts, otLocationState, $analytics, $injector, otConfig) {
        'use strict';
        ...
        var isSelected = function (collection, key) {
            var fcts = otLocationState.getState()[otFacetsFilters.stateId];
        ...
        var updateLocationSearch = function () {
            ...
            otLocationState.setStateFor(otFacetsFilters.stateId, raw);
        };
         ...
         * 
         * @example
         *      otFacetsFilters.pageFacetsStack(["datatypes","pathway_types"])
         */
        otFacetsFilters.pageFacetsStack = function (facets) {
            if (facets) {
         ...
         */
        otFacetsFilters.getFilters = function () {
            return filters;
        };
         ...
         */
        otFacetsFilters.getSelectedFilters = function () {
            return selected;
        };
         ...
         */
        otFacetsFilters.deselectAll = function () {
            // TODO: this could be changed so that removeFilter() takes an array as first parameter
            // selected.forEach(function(collection){
            //     otFacetsFilters.removeFilter(collection.key, null);
            // });
            selected.length = 0;
            updateLocationSearch();
        };
         ...
         */
        otFacetsFilters.updateFacets = function (facets, countsToUse) {
         ...
         */
        otFacetsFilters.getSelectedCount = function () {
         ...
         */
        otFacetsFilters.reset = function () {
            for (var key in filtersData) {
                if (filtersData.hasOwnProperty(key)) {
                    delete filtersData[key];
                }
        ...
        otFacetsFilters.update = function () {
            update();
        };
         ...
         */
        otFacetsFilters.isSelected = isSelected;


        return otFacetsFilters;
    }]);
