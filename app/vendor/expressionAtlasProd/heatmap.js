        ...
        var GeneProfileRow = (function (contextRoot, toolTipHighlightedWords, isExactMatch, enableGeneLinks, enableEnsemblLauncher, geneQuery) {
            ...
            return React.createClass({
                ...
                geneNameLinked: function () {
                    ...
                    var url = "http://www.ebi.ac.uk/gxa" + (type.isMultiExperiment ? experimentURL : geneURL);
                    ...
                    return (
                        React.DOM.span({title: titleTooltip, style: {"float": "left"}},
                            ...
                            React.DOM.a({ref: "geneName", target: "_blank", title: "", id: this.props.showGeneSetProfiles ? '' : this.props.id, href: url, onClick: this.geneNameLinkClicked, style: {"vertical-align": "15%"}}, this.props.name)
                        )
                    );
                },
